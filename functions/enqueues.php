...
if ( ! function_exists('b5st_enqueues') ) {
	function b5st_enqueues() {
		...
		wp_register_style('bootstrap5', 'https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta3/dist/css/bootstrap.min.css', false, '5.0.0-beta3', null);
		...
		wp_register_script('bootstrap5', 'https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta3/dist/js/bootstrap.bundle.min.js', false, '5.0.0-beta3', true);
